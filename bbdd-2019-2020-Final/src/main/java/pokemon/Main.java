	...
	public static void main (String[] args) {
		...
		do {
			...
			case '3':
				...
				break;
			case '4':
				System.out.println("Cuantos das quieres que dure la pandemia?");
				String dias_texto;
				do {
					dias_texto = sc.nextLine();
					if (!Main.isNatural(dias_texto))
						System.out.println("Introduce un numero natural de das.");
				...
				System.out.println("Se han infectado " + infectados + " pokemon.");
				break;
			case '5':
